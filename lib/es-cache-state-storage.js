...
class EsCacheStateStorage extends CacheStateStorage {
    constructor(context, config) {
        ...
        this.persist_field = config.persist_field || this.id_field;
        ...
        mgetResults.forEach((result) => {
            result.docs.forEach((doc) => {
                if (doc.found) {
                    ...
                    // _.set doesn't work here with subdomains
                    doc._source[this.id_field] = doc._id;
